...
export default function CompanyDetailPage({ params }: { params: Promise<{ locale: string; id: string }> }) {
  ...
  const targetRepresentative = company.representative[locale as 'en' | 'ko'] || company.representative['en'];
...
// Separate component for Analysis Logic to keep page clean
import Tabs from '@/components/common/Tabs';
import { MOCK_VOTES } from '@/lib/mock-data';
